...
class UniversalDependencyTreeBankFeatures {
    featureList = new Map();
    static universalFeatureTypes = ["PronType", "NumType", "Poss", "Reflex", "Foreign",
    ...
    static universalFeatureValues = [["Art", "Dem", "Emp", "Exc", "Ind", "Int", "Neg", "Prs", "Rcp", "Rel", "Tot"],
        ...
        ["Ex", "In"],
        ["Word", "Digit", "Roman"]];
    static turkishFeatureValues = [["Art", "Dem", "Ind", "Int", "Neg", "Prs", "Rcp", "Rel", "Tot"],
        ["Card", "Dist", "Ord"],
        [],
        ["Yes"],
        ["Yes"],
        ...
        [],
        []];
    static englishFeatureValues = [["Art", "Dem", "Emp", "Ind", "Int", "Neg", "Prs", "Rcp", "Rel", "Tot"],
        ["Card", "Frac", "Mult", "Ord"],
        ["Yes"],
        ["Yes"],
        ["Yes"],
